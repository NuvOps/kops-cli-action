# Copyright 2020 The NuvOps Team
#
...
#     https://github.com/kubernetes/kops/blob/master/docker/Dockerfile
#
...
LABEL "version"="${KOPS_GITISH}"
LABEL "com.github.actions.name"="KOPS"
LABEL "com.github.actions.description"="GitHub Action for KOPS"
